...
export function useCommands(commandManager: CommandManager, depCmdProvider: DepCmdProvider) {
  // 注册视图相关命令
  useViewCommands(commandManager, depCmdProvider)

  // 注册命令操作相关命令
  useCommandOperations(commandManager, depCmdProvider)

  // 注册分类操作相关命令
  useCategoryOperations(commandManager, depCmdProvider)

  // 注册数据管理相关命令
  useDataManagement(commandManager, depCmdProvider)
}
